...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initCategories() {
        ...
        findOrCreate("Продуктовый магазин", food,
                "продуктовый магазин,супермаркет,гастроном,магазин продуктов,продукты питания,минимаркет,гипермаркет");
        ...
        findOrCreate("Бар", food,
                "паб,пивной бар,коктейльный бар,ночной клуб,бар ");

        // ── Красота и здоровье ───────────────────────────────────────────────
        BusinessCategory beauty = findOrCreate("Красота и здоровье", null, null);

        findOrCreate("Аптека", beauty,
                "аптека,фармация,аптечный пункт");
        findOrCreate("Парикмахерская", beauty,
                "парикмахерская,барбершоп,студия стрижки");
        findOrCreate("Салон красоты", beauty,
                "салон красоты,beauty studio,студия красоты");
        findOrCreate("Маникюр и педикюр", beauty,
                "маникюр,педикюр,ногтевой сервис,nail studio");
        findOrCreate("Косметология", beauty,
                "косметология,спа,spa,массаж,уход за кожей");
        ...
        findOrCreate("Одежда", goods,
                "магазин одежды,одежда,бутик,мода,fashion");
        findOrCreate("Обувь", goods,
                "магазин обуви,обувной магазин,обувь");
